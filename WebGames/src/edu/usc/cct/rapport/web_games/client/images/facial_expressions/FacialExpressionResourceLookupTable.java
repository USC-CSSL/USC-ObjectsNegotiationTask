...
public class FacialExpressionResourceLookupTable {
	...
	public FacialExpressionResourceLookupTable() {
		...
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.sad_neutral2), webGamesClientBundle.drama_face_mask_sad_neutral2());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.sad_neutral_player), webGamesClientBundle.drama_face_mask_sad_neutral_player());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.sad_neutral_player2), webGamesClientBundle.drama_face_mask_sad_neutral_player2());
		...
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.angry_neutral2), webGamesClientBundle.drama_face_mask_angry_neutral2());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.angry_neutral_player), webGamesClientBundle.drama_face_mask_angry_neutral_player());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.angry_neutral_player2), webGamesClientBundle.drama_face_mask_angry_neutral_player2());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.happy_neutral_player), webGamesClientBundle.drama_face_mask_happy_neutral_player());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.happy_neutral_player2), webGamesClientBundle.drama_face_mask_happy_neutral_player2());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.content_neutral_player), webGamesClientBundle.drama_face_mask_content_neutral_player());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.content_neutral_player2), webGamesClientBundle.drama_face_mask_content_neutral_player2());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.content), webGamesClientBundle.drama_face_mask_content());
		this.facialExpressionImageResources.put(new Pair<FacialExpressionStyleEnum, FacialExpressionEnum>(FacialExpressionStyleEnum.drama_masks, FacialExpressionEnum.happy), webGamesClientBundle.drama_face_mask_happy());
	};

...
public class PrespecifiedNonconcederFruits2 implements PlyRemainingIndexedProposalGenerator {
	...
	public Proposal getPrespecifiedPotentialCounterproposal(final EnumSet<TradingObjectEnum> setOfTradingObjectEnum, final int plyRemaining) {
		...
		switch (turnsRemaining) {
			case 1:
				prespecifiedTradingObjectCounts = new int[]{4, 3, 3};
				break;
			case 2:
				prespecifiedTradingObjectCounts = new int[]{4, 3, 3};
				break;
			case 3:
				prespecifiedTradingObjectCounts = new int[]{4, 3, 4};
				break;
			case 4:
				prespecifiedTradingObjectCounts = new int[]{4, 4, 4};
				break;
			case 5:
				prespecifiedTradingObjectCounts = new int[]{5, 4, 4};
				break;
			case 6:

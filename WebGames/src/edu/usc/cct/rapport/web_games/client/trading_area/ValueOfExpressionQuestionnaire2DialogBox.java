...
public class ValueOfExpressionQuestionnaire2DialogBox extends DialogBox {
...
//	final ArrayList<ArrayList<RadioButton>> veq_questions = new ArrayList<ArrayList<RadioButton>>(); 
	...
	public ValueOfExpressionQuestionnaire2DialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions) {
		super(false, true);
		...
		if (localName == "en" || localName == "ko"){			
			...
			questions_label.add(new Label(constants.veq07()));
			questions_label.add(new Label(constants.veq08()));
			questions_label.add(new Label(constants.veq09()));
			questions_label.add(new Label(constants.veq10()));
			questions_label.add(new Label(constants.veq11()));
	...
	public void submit(final ExperimentConditions experimentConditions) {
		...
		btnSubmit.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				hide();
				experimentConditions.setVEQ_07(userAnswer[0]);
				experimentConditions.setVEQ_08(userAnswer[1]);
				experimentConditions.setVEQ_09(userAnswer[2]);
				experimentConditions.setVEQ_10(userAnswer[3]);
				experimentConditions.setVEQ_11(userAnswer[4]);

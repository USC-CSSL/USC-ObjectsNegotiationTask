...
public class FixedSadNeutralReactionAfter134 implements IComputeFacialExpressionAndIntensity {
	...
	public FixedSadNeutralReactionAfter134(final FacialExpressionEnum constantFacialExpressionEnum) {
	...
	public Pair<FacialExpressionEnum, Double> computeFacialExpressionAndIntensity(final double emotionValue, final RelativePowerEnum relativePowerEnum) {
		...
		if (emotionValue == 13 || emotionValue == 9) { // after round 1 and 3
			...
			fixedEmotionalReaction = new FixedEmotionalReaction(FacialExpressionEnum.sad_neutral2);			
		} else {

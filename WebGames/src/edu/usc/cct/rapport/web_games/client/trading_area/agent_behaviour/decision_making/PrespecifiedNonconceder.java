...
public class PrespecifiedNonconceder implements PlyRemainingIndexedProposalGenerator {
...
/*		case 1:
		...
		case 2:
			...
			break;
		case 3:
			prespecifiedTradingObjectCounts = new int[]{2, 3, 4, 2};
			break;
		case 4:
			prespecifiedTradingObjectCounts = new int[]{2, 3, 4, 2};
			break;
		case 5:
			prespecifiedTradingObjectCounts = new int[]{2, 4, 4, 2};
			break;
		case 6:
			prespecifiedTradingObjectCounts = new int[]{2, 4, 4, 2};
			break;
		case 7:
			prespecifiedTradingObjectCounts = new int[]{3, 4, 4, 3};
			break;
		case 8:
			prespecifiedTradingObjectCounts = new int[]{3, 4, 4, 3};
			break;
		...
		case 10:
			...
			break;
		case 11:
			prespecifiedTradingObjectCounts = new int[]{4, 4, 4, 4};
			break;
		default:
			prespecifiedTradingObjectCounts = new int[]{4, 4, 4, 4};*/
...
/*		case 1:
		...
		case 2:
			...
			break;
		case 3:
			prespecifiedTradingObjectCounts = new int[]{1, 1, 2, 1};
			break;
		case 4:
			prespecifiedTradingObjectCounts = new int[]{3, 1, 2, 1};
			break;
		case 5:
			prespecifiedTradingObjectCounts = new int[]{3, 1, 3, 1};
			break;
		case 6:
			prespecifiedTradingObjectCounts = new int[]{3, 1, 3, 1};
			break;
		case 7:
			...
			break;
		case 8:
			prespecifiedTradingObjectCounts = new int[]{3, 2, 3, 2};
			break;
		case 9:
		...
		case 4:
			...
			break;
		case 5:
			prespecifiedTradingObjectCounts = new int[]{4, 5, 4, 4};
			break;
		case 6:
			prespecifiedTradingObjectCounts = new int[]{4, 5, 4, 4};
			break;
		case 7:
			prespecifiedTradingObjectCounts = new int[]{4, 5, 5, 5};
			break;
		case 8:
			prespecifiedTradingObjectCounts = new int[]{5, 3, 3, 3};
			break;
		case 9:
			prespecifiedTradingObjectCounts = new int[]{5, 4, 4, 3};
			break;
		case 10:
			prespecifiedTradingObjectCounts = new int[]{5, 5, 4, 4};
			break;
		case 11:

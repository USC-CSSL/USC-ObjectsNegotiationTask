...
public class FairnessQuestionnaire5DialogBox extends DialogBox {
	...
	public FairnessQuestionnaire5DialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions, final int plyRemaining) {
		super(false, true);
...
//		setHTML("Questionnaire");
		...
		if(experimentConditions.getPartnerLabel()==0)
			explanation1 = new HTML(constants.fairness_explanation_offer5_part1_computer_partner());
		else if(experimentConditions.getPartnerLabel()==1)
			explanation1 = new HTML(constants.fairness_explanation_offer5_part1_human_partner());
		...
		if(experimentConditions.getPartnerLabel()==0) {	
			if(experimentConditions.getDecisionMakingStrategyOfAlgorithmicCounterpart().equals(AlgorithmicCounterpartDecisionMakingStrategyEnum.prespecifiedSoftGentleSlopeStrategyFruits1)) {
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits1_offer5_cc.png");
				...
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits3_offer5_cc.png");
				...
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits5_offer5_cc.png");
				...
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits7_offer5_cc.png");
			}			
		} else if (experimentConditions.getPartnerLabel()==1) {
			if(experimentConditions.getDecisionMakingStrategyOfAlgorithmicCounterpart().equals(AlgorithmicCounterpartDecisionMakingStrategyEnum.prespecifiedSoftGentleSlopeStrategyFruits1)) {
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits1_offer5_a.png");
			} else if(experimentConditions.getDecisionMakingStrategyOfAlgorithmicCounterpart().equals(AlgorithmicCounterpartDecisionMakingStrategyEnum.prespecifiedSoftSteepSlopeStrategyFruits3)) {
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits3_offer5_a.png");
			} else if(experimentConditions.getDecisionMakingStrategyOfAlgorithmicCounterpart().equals(AlgorithmicCounterpartDecisionMakingStrategyEnum.prespecifiedToughGentleSlopeStrategyFruits5)) {
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits5_offer5_a.png");
			} else if(experimentConditions.getDecisionMakingStrategyOfAlgorithmicCounterpart().equals(AlgorithmicCounterpartDecisionMakingStrategyEnum.prespecifiedToughSteepSlopeStrategyFruits7)) {
				offer.setUrl("http://shiraz.usc.edu/negotiation/images/fruits7_offer5_a.png");
			}
		}

		HTML explanation2 = new HTML();	    		
		if(experimentConditions.getPartnerLabel()==0)
			explanation2 = new HTML(constants.fairness_explanation_offer5_part2_computer_partner());
		else if(experimentConditions.getPartnerLabel()==1)
			explanation2 = new HTML(constants.fairness_explanation_offer5_part2_human_partner());
	...
	public void submit(final ExperimentConditions experimentConditions, final int plyRemaining) {
		...
		btnSubmit.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {				
				if(plyRemaining < 4) {// if the participant saw the agent's second offer
					final FairnessQuestionnaire6DialogBox dialogBox = new FairnessQuestionnaire6DialogBox (eventBus, experimentConditions, plyRemaining);
				...
				hide();
				experimentConditions.setFairnessOfTheAgentOffer_5(userAnswer[0]);

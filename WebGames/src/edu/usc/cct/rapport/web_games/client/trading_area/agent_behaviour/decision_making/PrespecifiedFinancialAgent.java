...
public class PrespecifiedFinancialAgent implements PlyRemainingIndexedProposalGenerator {
...
//[documents, reform, bonus]
		...
		case 9:
			...
			break;
		case 8:
			prespecifiedTradingObjectCounts = new int[]{5, 5, 3};
			break;
		case 7:
			prespecifiedTradingObjectCounts = new int[]{5, 5, 2};
			break;
		case 6:
			prespecifiedTradingObjectCounts = new int[]{5, 5, 1};
			break;
		case 5:
			prespecifiedTradingObjectCounts = new int[]{5, 5, 1};
			break;

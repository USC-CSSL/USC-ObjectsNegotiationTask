...
public class PrespecifiedToughSteepSlopeStrategyFruits6 implements PlyRemainingIndexedProposalGenerator {
...
//				prespecifiedTradingObjectCounts = new int[]{2, 1, 2};	// item1(3), item2(4), item3(5) >> 1 2 3	(fruits1 set)
				prespecifiedTradingObjectCounts = new int[]{2, 1, 2};	// item1(5), item2(4), item3(3) >> 3 2 1	(fruits6 set)
				break;
			case 2:

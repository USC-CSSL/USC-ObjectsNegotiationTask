...
public class PrespecifiedSoftGentleSlopeStrategyFruits4 implements PlyRemainingIndexedProposalGenerator {
...
//				prespecifiedTradingObjectCounts = new int[]{1, 1, 2};	// item1(3), item2(4), item3(5) >> 1 2 3	(fruits1 set)
				prespecifiedTradingObjectCounts = new int[]{1, 2, 1};	// item1(3), item2(5), item3(4) >> 1 3 2	(fruits4 set)
				break;
			case 2:
//				prespecifiedTradingObjectCounts = new int[]{1, 1, 2};
				prespecifiedTradingObjectCounts = new int[]{1, 2, 1};
				break;
			case 3:
...
//				prespecifiedTradingObjectCounts = new int[]{2, 0, 3};
				prespecifiedTradingObjectCounts = new int[]{2, 3, 0};
				break;
			case 5:
...
//				prespecifiedTradingObjectCounts = new int[]{1, 2, 3};
				prespecifiedTradingObjectCounts = new int[]{1, 3, 2};
		};

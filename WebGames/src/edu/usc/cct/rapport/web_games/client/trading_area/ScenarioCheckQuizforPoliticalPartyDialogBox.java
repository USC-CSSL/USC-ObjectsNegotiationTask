...
public class ScenarioCheckQuizforPoliticalPartyDialogBox extends DialogBox {
	...
	public ScenarioCheckQuizforPoliticalPartyDialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions){
		super(false, true);
		...
		absolutePanel.setSize("700px", "725px");
	
		if (localName == "en"){
			HTML part1 = new HTML(constants.scenario_quiz_part1());
			HTML quiz1 = new HTML(constants.scenario_quiz_forPoliticalParty_no1()); 
			absolutePanel.add(part1, 10, 10);			
			absolutePanel.add(quiz1, 10, 35);			
			
			RadioButton radioButtonQuestions1_1  = new RadioButton("Quiz1");
			radioButtonQuestions1_1.setHTML(constants.scenario_quiz_forPoliticalParty_no1_ans1());
			...
			radioButtonQuestions1_2.setHTML(constants.scenario_quiz_forPoliticalParty_no1_ans2());
			radioButtonQuestions1_2.setFormValue("2");
			absolutePanel.add(radioButtonQuestions1_2, 20, 85);
			Quiz1.add(radioButtonQuestions1_2);
		
			RadioButton radioButtonQuestions1_3 = new RadioButton("Quiz1");
			radioButtonQuestions1_3.setHTML(constants.scenario_quiz_forPoliticalParty_no1_ans3());
			radioButtonQuestions1_3.setFormValue("3");
			absolutePanel.add(radioButtonQuestions1_3, 20, 110);
			Quiz1.add(radioButtonQuestions1_3);
		
	    	VerticalSplitPanel verticalSplitPanel = new VerticalSplitPanel();
			absolutePanel.add(verticalSplitPanel, 109, 135);
			verticalSplitPanel.setSize("446px", "32px");
			
			////////////////////////////////////////////////////////////////////////////////////		
			
			HTML quiz2 = new HTML(constants.scenario_quiz_forPoliticalParty_no2()); 
			absolutePanel.add(quiz2, 10, 185);			
			
			RadioButton radioButtonQuestions2_1  = new RadioButton("Quiz2");
			radioButtonQuestions2_1.setHTML(constants.scenario_quiz_forPoliticalParty_no2_ans1());
			radioButtonQuestions2_1.setFormValue("1");
			absolutePanel.add(radioButtonQuestions2_1, 20, 210);
			Quiz2.add(radioButtonQuestions2_1);
		
			RadioButton radioButtonQuestions2_2 = new RadioButton("Quiz2");
			radioButtonQuestions2_2.setHTML(constants.scenario_quiz_forPoliticalParty_no2_ans2());
			radioButtonQuestions2_2.setFormValue("2");
			absolutePanel.add(radioButtonQuestions2_2, 20, 235);
			Quiz2.add(radioButtonQuestions2_2);
		
			RadioButton radioButtonQuestions2_3 = new RadioButton("Quiz2");
			radioButtonQuestions2_3.setHTML(constants.scenario_quiz_forPoliticalParty_no2_ans3());
			radioButtonQuestions2_3.setFormValue("3");
			absolutePanel.add(radioButtonQuestions2_3, 20, 260);
			Quiz2.add(radioButtonQuestions2_3);
		
	    	VerticalSplitPanel verticalSplitPanel2 = new VerticalSplitPanel();
			absolutePanel.add(verticalSplitPanel2, 109, 285);
			verticalSplitPanel2.setSize("446px", "32px");
			
			////////////////////////////////////////////////////////////////////////////////////		
			
			HTML quiz3 = new HTML(constants.scenario_quiz_forPoliticalParty_no3()); 
			absolutePanel.add(quiz3, 10, 335);			
			
			RadioButton radioButtonQuestions3_1  = new RadioButton("Quiz3");
			radioButtonQuestions3_1.setHTML(constants.scenario_quiz_forPoliticalParty_no3_ans1());
			radioButtonQuestions3_1.setFormValue("1");
			absolutePanel.add(radioButtonQuestions3_1, 20, 360);
			Quiz3.add(radioButtonQuestions3_1);
		
			RadioButton radioButtonQuestions3_2 = new RadioButton("Quiz3");
			radioButtonQuestions3_2.setHTML(constants.scenario_quiz_forPoliticalParty_no3_ans2());
			radioButtonQuestions3_2.setFormValue("2");
			absolutePanel.add(radioButtonQuestions3_2, 20, 385);
			Quiz3.add(radioButtonQuestions3_2);
		
			RadioButton radioButtonQuestions3_3 = new RadioButton("Quiz3");
			radioButtonQuestions3_3.setHTML(constants.scenario_quiz_forPoliticalParty_no3_ans3());
			radioButtonQuestions3_3.setFormValue("3");
			absolutePanel.add(radioButtonQuestions3_3, 20, 410);
			Quiz3.add(radioButtonQuestions3_3);
		
	    	VerticalSplitPanel verticalSplitPanel3 = new VerticalSplitPanel();
			absolutePanel.add(verticalSplitPanel3, 109, 435);
			...
			absolutePanel.add(part2, 10, 485);			
			absolutePanel.add(quiz4, 10, 510);			
			...
			absolutePanel.add(radioButtonQuestions4_1, 20, 535);
			...
			absolutePanel.add(radioButtonQuestions4_2, 320, 535);
			...
			absolutePanel.add(radioButtonQuestions5_1, 20, 635);
...
//				dialogBox.center();
				...
				if(!getAnswers(Quiz1).equals("0") & !getAnswers(Quiz2).equals("0") & !getAnswers(Quiz3).equals("0") & !getAnswers(Quiz4).equals("0") 
					...
					if(getAnswers(Quiz1).equals(constants.scenario_quiz_forPoliticalParty_no1_ans()) 			& getAnswers(Quiz2).equals(constants.scenario_quiz_forPoliticalParty_no2_ans()) 
							& getAnswers(Quiz3).equals(constants.scenario_quiz_forPoliticalParty_no3_ans()) 	& getAnswers(Quiz4).equals(constants.scenario_quiz_no4_ans()) 

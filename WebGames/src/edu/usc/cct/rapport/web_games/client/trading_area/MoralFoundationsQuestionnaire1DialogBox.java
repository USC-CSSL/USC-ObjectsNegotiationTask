...
public class MoralFoundationsQuestionnaire1DialogBox extends DialogBox {
	...
	public MoralFoundationsQuestionnaire1DialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions) {
		...
		if (localName == "en" || localName == "ko"){			
			...
			questions_label.add(new Label(constants.mfq01()));
			questions_label.add(new Label(constants.mfq02()));
			questions_label.add(new Label(constants.mfq03()));
			questions_label.add(new Label(constants.mfq04()));
			questions_label.add(new Label(constants.mfq05()));
			questions_label.add(new Label(constants.mfq06()));
			questions_label.add(new Label(constants.mfq07()));
			questions_label.add(new Label(constants.mfq08()));
	...
	public void submit(final ExperimentConditions experimentConditions) {
		...
		btnSubmit.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				hide();
				experimentConditions.setMFQ_01(userAnswer[0]);
				experimentConditions.setMFQ_02(userAnswer[1]);
				experimentConditions.setMFQ_03(userAnswer[2]);
				experimentConditions.setMFQ_04(userAnswer[3]);
				experimentConditions.setMFQ_05(userAnswer[4]);
				experimentConditions.setMFQ_06(userAnswer[5]);
				experimentConditions.setMFQ_07(userAnswer[6]);
				experimentConditions.setMFQ_08(userAnswer[7]);

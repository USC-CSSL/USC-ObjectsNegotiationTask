...
public class FairnessQuestionnaire6DialogBox extends DialogBox {
	...
	public FairnessQuestionnaire6DialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions, final int plyRemaining) {
		super(false, true);
...
//		setHTML("Questionnaire");
		...
		if(experimentConditions.getPartnerLabel()==0)
			explanation1 = new HTML(constants.fairness_explanation_offer6_part1_computer_partner());
		else if(experimentConditions.getPartnerLabel()==1)
			explanation1 = new HTML(constants.fairness_explanation_offer6_part1_human_partner());
		...
		if(experimentConditions.getPartnerLabel()==0)
			explanation2 = new HTML(constants.fairness_explanation_offer6_part2_computer_partner());
		else if(experimentConditions.getPartnerLabel()==1)
			explanation2 = new HTML(constants.fairness_explanation_offer6_part2_human_partner());
	...
	public void submit(final ExperimentConditions experimentConditions, final int plyRemaining) {
		...
		btnSubmit.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {				
				...
				dialogBox.show();
				hide();
				experimentConditions.setFairnessOfTheAgentOffer_6(userAnswer[0]);

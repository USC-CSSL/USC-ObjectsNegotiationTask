...
public class PrespecifiedToughGentleSlopeStrategyFruits5 implements PlyRemainingIndexedProposalGenerator {
...
//				prespecifiedTradingObjectCounts = new int[]{0, 2, 3};	// item1(4), item2(3), item3(5) >> 2 1 3	(fruits5 set)
				break;
			case 2:

...
public class PartnerAssignmentResultDialogBox extends DialogBox {
	...
	public PartnerAssignmentResultDialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions) {
...
//		this.setText(titleDiscription);
		...
		HTML partnerAssignmentResult = new HTML("");

		if (partnerLabel == 0) {
			partnerAssignmentResult.setHTML(constants.partnerAssignmentResult_computer());
		} else if(partnerLabel == 1) {			
			partnerAssignmentResult.setHTML(constants.partnerAssignmentResult_human());
		} else {
			partnerAssignmentResult.setHTML(constants.partnerAssignmentResult());
		}
		
		flexTable.setWidget(0, 0, partnerAssignmentResult);

...
public class PrespecifiedSoftSteepSlopeStrategyFruits4 implements PlyRemainingIndexedProposalGenerator {
	...
	public Proposal getPrespecifiedPotentialCounterproposal(final EnumSet<TradingObjectEnum> setOfTradingObjectEnum, final int plyRemaining) {
		...
		// fruits negotiation: 3 items each 
			case 1:
//				prespecifiedTradingObjectCounts = new int[]{0, 2, 1};	// item1(3), item2(4), item3(5) >> 1 2 3
				prespecifiedTradingObjectCounts = new int[]{0, 1, 2};	// item1(3), item2(5), item3(4) >> 1 3 2
				break;
			case 2:
//				prespecifiedTradingObjectCounts = new int[]{0, 2, 1};
				prespecifiedTradingObjectCounts = new int[]{0, 1, 2};
				break;
			case 3:

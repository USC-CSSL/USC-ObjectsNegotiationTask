...
public class ScenarioCheckQuizforNSADialogBox extends DialogBox {
	...
	public ScenarioCheckQuizforNSADialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions){
		super(false, true);
		...
		if (localName == "en"){
			...
			HTML quiz1 = new HTML(constants.scenario_quiz_forNSA_no1()); 
			absolutePanel.add(part1, 10, 10);			
			absolutePanel.add(quiz1, 10, 35);			
			
			RadioButton radioButtonQuestions1_1  = new RadioButton("Quiz1");
			radioButtonQuestions1_1.setHTML(constants.scenario_quiz_forNSA_no1_ans1());
			...
			radioButtonQuestions1_2.setHTML(constants.scenario_quiz_forNSA_no1_ans2());
			...
			radioButtonQuestions1_3.setHTML(constants.scenario_quiz_forNSA_no1_ans3());
			...
			HTML quiz2 = new HTML(constants.scenario_quiz_forNSA_no2()); 
			absolutePanel.add(quiz2, 10, 185);			
			
			RadioButton radioButtonQuestions2_1  = new RadioButton("Quiz2");
			radioButtonQuestions2_1.setHTML(constants.scenario_quiz_forNSA_no2_ans1());
			...
			radioButtonQuestions2_2.setHTML(constants.scenario_quiz_forNSA_no2_ans2());
			...
			radioButtonQuestions2_3.setHTML(constants.scenario_quiz_forNSA_no2_ans3());
			...
			HTML quiz3 = new HTML(constants.scenario_quiz_forNSA_no3()); 
			absolutePanel.add(quiz3, 10, 335);			
			
			RadioButton radioButtonQuestions3_1  = new RadioButton("Quiz3");
			radioButtonQuestions3_1.setHTML(constants.scenario_quiz_forNSA_no3_ans1());
			...
			radioButtonQuestions3_2.setHTML(constants.scenario_quiz_forNSA_no3_ans2());
			...
			radioButtonQuestions3_3.setHTML(constants.scenario_quiz_forNSA_no3_ans3());

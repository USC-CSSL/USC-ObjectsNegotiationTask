...
public class MoralFoundationsQuestionnaire4DialogBox extends DialogBox {
	...
	public MoralFoundationsQuestionnaire4DialogBox(final EventBus eventBus, final ExperimentConditions experimentConditions) {
		super(false, true);
		...
		if (localName == "en" || localName == "ko"){			
			...
			questions_label.add(new Label(constants.mfq25()));
			questions_label.add(new Label(constants.mfq26()));
			questions_label.add(new Label(constants.mfq27()));
			questions_label.add(new Label(constants.mfq28()));
			questions_label.add(new Label(constants.mfq29()));
			questions_label.add(new Label(constants.mfq30()));
			questions_label.add(new Label(constants.mfq31()));
			questions_label.add(new Label(constants.mfq32()));
	...
	public void submit(final ExperimentConditions experimentConditions) {
		...
		btnSubmit.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				hide();
				experimentConditions.setMFQ_25(userAnswer[0]);
				experimentConditions.setMFQ_26(userAnswer[1]);
				experimentConditions.setMFQ_27(userAnswer[2]);
				experimentConditions.setMFQ_28(userAnswer[3]);
				experimentConditions.setMFQ_29(userAnswer[4]);
				experimentConditions.setMFQ_30(userAnswer[5]);
